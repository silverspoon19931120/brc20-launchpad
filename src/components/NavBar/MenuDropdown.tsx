          ...
          <NavDropdown top={{ sm: 'unset', lg: '56' }} bottom={{ sm: '56', lg: 'unset' }} right="0">
            <Column gap="16">
              <Column paddingX="8" gap="4">
                ...
                <PrimaryMenuRow href="https://www.coindesk.com/learn/brc-20-explained-how-tokens-on-bitcoin-work-and-why-they-are-controversial/">
                  <Icon>
                    <BarChartIcon width={24} height={24} />
                  </Icon>
                  <PrimaryMenuRow.Text>
                    <Trans>About BRC20</Trans>
                  </PrimaryMenuRow.Text>
                </PrimaryMenuRow>
              </Column>
              <Separator />
              ...
              <IconRow>
                ...
                <Icon href="https://twitter.com/majobrc20">
                  <TwitterIconMenu
                    className={styles.hover}
                    width={24}
                    height={24}
                ...
                <Icon href="https://github.com/majobrc20">
                  <GithubIconMenu
                    className={styles.hover}
                    width={24}
                    height={24}
